...
dependencies {
    implementation 'com.github.edge-base.edgebase:edgebase-android-java:v0.3.7'
}
```
...
dependencies {
    implementation 'com.github.edge-base.edgebase:edgebase-admin-java:v0.3.7'
}
```
...
libraryDependencies += "com.github.edge-base.edgebase" % "edgebase-admin-scala" % "v0.3.7"
```
