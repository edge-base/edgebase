...
// Package.swift
dependencies: [
    .package(url: "https://github.com/edge-base/edgebase-swift", from: "0.3.1")
]
```
...
dependencies {
    implementation 'com.github.edge-base.edgebase:edgebase-android-java:v0.3.1'
}
```
...
dependencies {
    implementation 'com.github.edge-base.edgebase:edgebase-admin-java:v0.3.1'
}
```
...
libraryDependencies += "com.github.edge-base.edgebase" % "edgebase-admin-scala" % "v0.3.1"
```
