...
- **Capabilities**: [State (Room State)](/docs/room/state), [Meta (Room Info)](/docs/room/meta), [Members (Presence)](/docs/room/members), [Signals (Broadcast)](/docs/room/signals), and [Media (Voice/Video)](/docs/room/media) *(alpha)* are the five primary Room surfaces.
:::
