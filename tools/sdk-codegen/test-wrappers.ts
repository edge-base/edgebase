...
const EXCLUDED_OPS: Record<string, string> = {
  ...
  authMfaRecoveryCodesRegenerate: 'auth SDK direct HTTP',
  ...
  adminListNamespaceInstances: 'admin dashboard',
  ...
  adminDestroyApp: 'admin dashboard',
  // ── Admin: Backup ──
  ...
  adminBackupDumpData: 'admin backup',
  adminBackupRestoreData: 'admin backup',
