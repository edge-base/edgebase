...
import type { AuthContext, TableRules, DbLevelRules } from '@edgebase/shared';
import { EdgeBaseError, getDbAccess, getTableAccess } from '@edgebase/shared';
...
): import('@edgebase/shared').DbRuleCtx {
  return {
    db: {
      async get(table, id) {
