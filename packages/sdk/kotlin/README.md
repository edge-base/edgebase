...
| --- | --- | --- |
| `:core` | `com.github.edge-base.edgebase:edgebase-core:v0.3.0` | current JitPack route publishes the JVM variant of the shared runtime |
| `:client` | `com.github.edge-base.edgebase:edgebase-client:v0.3.0` | current JitPack route publishes the JVM variant of the client runtime |
| `:admin` | `com.github.edge-base.edgebase:edgebase-admin-kotlin:v0.3.0` | JVM only |
...
dependencies {
    implementation("com.github.edge-base.edgebase:edgebase-core:v0.3.0")
    implementation("com.github.edge-base.edgebase:edgebase-client:v0.3.0")
    implementation("com.github.edge-base.edgebase:edgebase-admin-kotlin:v0.3.0")
}
```
...
- JitPack versions use the repository tag, for example `v0.3.0`
