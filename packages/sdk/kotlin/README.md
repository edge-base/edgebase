...
| --- | --- | --- |
| `:core` | `com.github.edge-base.edgebase:edgebase-core:v0.2.3` | current JitPack route publishes the JVM variant of the shared runtime |
| `:client` | `com.github.edge-base.edgebase:edgebase-client:v0.2.3` | current JitPack route publishes the JVM variant of the client runtime; built-in Room Media ships on Android/iOS/JS and adapter-driven Room Media is available on JVM |
| `:admin` | `com.github.edge-base.edgebase:edgebase-admin-kotlin:v0.2.3` | JVM only |
...
dependencies {
    implementation("com.github.edge-base.edgebase:edgebase-core:v0.2.3")
    implementation("com.github.edge-base.edgebase:edgebase-client:v0.2.3")
    implementation("com.github.edge-base.edgebase:edgebase-admin-kotlin:v0.2.3")
}
```
...
- JitPack versions use the repository tag, for example `v0.2.3`
