...
| --- | --- | --- |
| `:packages:core` | `com.github.edge-base.edgebase:edgebase-core-scala:v0.4.5` | Scala wrappers for DB, storage, and shared result types |
| `:packages:admin` | `com.github.edge-base.edgebase:edgebase-admin-scala:v0.4.5` | Server-side admin SDK built on top of the Java admin SDK |
...
libraryDependencies ++= Seq(
  "com.github.edge-base.edgebase" % "edgebase-core-scala" % "v0.4.5",
  "com.github.edge-base.edgebase" % "edgebase-admin-scala" % "v0.4.5"
)
```
