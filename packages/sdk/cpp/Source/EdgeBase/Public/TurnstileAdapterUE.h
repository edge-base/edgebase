// EdgeBase — Unreal Engine hosted Turnstile adapter used by the packaged
// Source/EdgeBase plugin tree. Keep the protocol in sync with
// packages/unreal/include/edgebase/turnstile_adapter_ue.h.
