...
export {
  ...
  type TransactInsertResult,
  type TransactOperationResult,
  type TransactResults,
  type TransactResult,
  type CompactTransactResult,
  type TransactFullOptions,
  type TransactCompactOptions,
